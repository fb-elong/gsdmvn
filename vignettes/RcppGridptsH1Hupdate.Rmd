...
levels(mbm_gridpts$expr) <- c("old gridpts (tibble)", "old gridpts (list)", "new gridpts")
mbm_gridpts
```
...
mbm_gridpts2$expression[[1]] <- c("old gridpts (list)")
...
levels(mbm_h1$expr) <- c("old h1 (tibble)", "old h1 (list)", "new h1")
mbm_h1
```
...
mbm_h12$expression[[1]] <- c("old h1 (list)")
...
levels(mbm_hupdate$expr) <- c("old hupdate (tibble)", "old hupdate (list)", "new hupdate")
mbm_hupdate
```
...
mbm_hupdate2$expression[[1]] <- c("old hupdate (list)")
